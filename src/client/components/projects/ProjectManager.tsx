  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: '20px 24px', borderBottom: '1px solid #0f3460', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ padding: '16px 24px', borderBottom: '1px solid #0f3460' }}>
          ...
          <input
            className="stlab-input" placeholder="Project name (required)"
            value={newName} onChange={(e) => setNewName(e.target.value)}
            style={{ marginBottom: 8 }}
            onKeyDown={(e) => e.key === 'Enter' && handleCreate()}
          />
          <input
            className="stlab-input" placeholder="Description (optional)"
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '16px 24px' }}>
          ...
          {projects.map((p) => (
            <div
              ...
              style={{
                padding: '12px 16px', borderRadius: 8, cursor: loading ? 'wait' : 'pointer',
              ...
              onMouseEnter={(e) => { if (activeProjectId !== p.id) (e.currentTarget as HTMLElement).style.background = 'rgba(255,255,255,0.04)' }}
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                ...
                {activeProjectId === p.id && (
                  <span style={{ fontSize: 10, background: '#3b82f6', color: 'white', padding: '2px 8px', borderRadius: 10, fontWeight: 600 }}>OPEN</span>
                )}
              </div>
